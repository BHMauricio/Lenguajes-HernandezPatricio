...
public class P5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("5.¿Otros motivos por que se presenta elembarazo entre adolescentes? ");

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setText("Inicio precoz de relaciones sexuales");
        ...
        jRadioButton2.setText("Factores Socioculturales");

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("Familia disfuncional");

        buttonGroup1.add(jRadioButton4);
        jRadioButton4.setText("Abuso Sexual ");
